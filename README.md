...
| # | Exercise | Tools | Time |
|---|----------|-------|------|
| 1 | Researcher | Researcher (Critique + Model Council), Word Copilot | 15 min |
| 2 | Financial Analysis | Excel Copilot, Analyst Agent | 30 min |
| 3 | Contract & Reporting | Word Copilot, PowerPoint Copilot, Cowork | 30 min |
| 4 | Build Your Custom Agent | Microsoft 365 Agent Builder | 20 min |
...
The exercises are written against:

- **Bank Negara Malaysia** Outsourcing Policy `BNM/RH/PD 028-99`
...
- **Bursa Malaysia** Listing Requirements & National Sustainability Reporting Framework (ISSB IFRS S1 / S2 aligned)

---

## Hosting

Static site, hosted on GitHub Pages from `main` / `/`. No build step.
